...
class ConnectionToMySQL
{
    ...
    //glb_function.strDbCnnString ="server=localhost;port=3300;charset=utf8;database=Stations;userid=root;password=bigboss;SslMode=none;AllowPublicKeyRetrieval=True";
    ...
    internal int InsertDataWithBlob(string SqlSt, MySqlParameter para1, MySqlParameter para2, MySqlParameter para3)
    {
        try
        {
